...
* Beer Addict is now API 15+ only.
* I will also be implementing RxJava, Material design and a few other things into this app as well.
There will be *no upgrade path* as Beer Addict is mean to act as a starting point for Android Applications.

# Beer Addict App

[![Build Status](https://travis-ci.org/AndroidBootstrap/pl-beeraddict-baapp.svg?branch=master)](https://travis-ci.org/AndroidBootstrap/pl-beeraddict-baapp)

This repository contains the source code for the [Beer Addict](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=pl.beeraddict.baapp).

Please see the [issues](https://github.pl.beeraddict.baapp/pl-beeraddict-baapp/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about Beer Addict? Ask away on the [pl-beeraddict-baapp discussion forum](https://groups.google.com/forum/#!forum/pl-beeraddict-baapp).

<a href="https://play.google.com/store/apps/details?id=pl.beeraddict.baapp" alt="Download from Google Play">
...
code for the app will change:
  ...
  - From: __pl.beeraddict.baapp__
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____pl.beeraddict.baapp__ will be moved to the
new folder __com/notify/app/mobile__.

All import statments that reference the old resources (__R.pl.beeraddict.baapp.R__) will now be renamed
...
signed with a different key.  Manually uninstall Beer Addict from your device and
...
Beer Addict is a result of a template project I've developed over the years as well as
...
Beer Addict is built on the awesome [Parse.com API](http://www.parse.com/)
...
## Contributors
Thank you to all the [contributors](http://www.github.pl.beeraddict.baapp/pl-beeraddict-baapp/contributors) on
...
[pull requests](https://github.pl.beeraddict.baapp/pl-beeraddict-baapp/pulls).
