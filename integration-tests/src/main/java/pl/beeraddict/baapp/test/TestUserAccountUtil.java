...
package pl.beeraddict.baapp.test;
...
import static pl.beeraddict.baapp.core.Constants.Auth.*;

import pl.beeraddict.baapp.tests.R;
import pl.beeraddict.baapp.util.Ln;
