...
public final class Constants {
    ...
    public static final class Auth {
         ...
         * Account type id
         */
        public static final String BOOTSTRAP_ACCOUNT_TYPE = "pl.beeraddict.baapp";

        /**
         * Account name
         */
        public static final String BOOTSTRAP_ACCOUNT_NAME = "Beer Addict";

        /**
         * Provider id
         */
        public static final String BOOTSTRAP_PROVIDER_AUTHORITY = "pl.beeraddict.baapp.sync";
